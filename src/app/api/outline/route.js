    ...
    const messages = [
      ...
      },
      {
        ...
        content: [
          ...
          styleInstruction,
          termInstruction,
          "Create a clear outline with markdown formatting (**bold** for emphasis, *italic* for key terms, ### for section headers).",
          "Structure your response with:",
          "- ### **Main Ideas** (key concepts)",
          "- *Important Terms* (italicize definitions)",
          "- **Key Data Points** (bold for emphasis)",
          "- ### **Step-by-Step Plan** (numbered list)",
          "- ### **Why This Matters** (connect to student's interests/community)",
